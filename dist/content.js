...
bandar togel online
bandar slot online
`.split(/\r?\n/).map(e=>e.trim()).filter(Boolean),We=[`Boyer-Moore`,`KMP`,`Regex`,`Weighted-Levenshtein`,`OCR`],z=new Map,B=new Map,V=new Map,H=new Map,U=new Map,Ge=12,W=80,Ke=500,qe=200,Je=2,Ye=900,Xe=1600,Ze=6e4,Qe=45e3;We.forEach(e=>{V.set(e,0),H.set(e,0)});var $e=0,et=null,tt=!1,nt=!1,G,rt=!1,K=!1,q=new Set,J=document.createElement(`div`);J.style.position=`absolute`,J.style.display=`none`,J.style.backgroundColor=`#333`,J.style.color=`#fff`,J.style.padding=`8px`,J.style.borderRadius=`4px`,J.style.fontSize=`12px`,J.style.zIndex=`999999`,J.style.pointerEvents=`none`,J.style.lineHeight=`1.5`,document.body.appendChild(J);function it(e,t,n){let r=0,i=[];for(let e of t){let t=V.get(e.algorithm)||0;V.set(e.algorithm,t+e.stats.executionTimeMs);let n=H.get(e.algorithm)||0;if(H.set(e.algorithm,n+e.matches.length),typeof e.stats.comparisons==`number`){let t=U.get(e.algorithm)||0;U.set(e.algorithm,t+e.stats.comparisons)}for(let t of e.matches)i.push({...t,algorithms:new Set([e.algorithm])})}if(i.length>0){i.sort((e,t)=>e.startIndex-t.startIndex);let t=[];for(let e of i){let n=t[t.length-1];n&&n.startIndex===e.startIndex&&n.endIndex===e.endIndex?e.algorithms.forEach(e=>n.algorithms.add(e)):t.push(e)}let a=[],o=-1;for(let e of t)e.startIndex>=o&&(a.push(e),o=e.endIndex);if(a.length===0)return 0;let s=document.createDocumentFragment(),c=0;for(let t of a){let n=e.slice(c,t.startIndex);n&&s.appendChild(document.createTextNode(n));let i=document.createElement(`mark`);i.className=`sweetbonanza-highlighted-word`,i.style.backgroundColor=`red`,i.style.color=`white`,i.style.cursor=`help`,i.dataset.sweetbonanzaTextHighlight=`true`;let a=e.slice(t.startIndex,t.endIndex);i.textContent=a;let o=a.toLowerCase();z.set(o,(z.get(o)||0)+1),i.dataset.keyword=a,i.dataset.algorithms=Array.from(t.algorithms).join(`, `),rt&&(i.style.filter=`blur(4px)`,i.dataset.sweetbonanzaBlurred=`true`),s.appendChild(i),c=t.endIndex,r++}let l=e.slice(c);l&&s.appendChild(document.createTextNode(l)),n.parentNode?.replaceChild(s,n)}return r}function at(e){return ot()?.runtime?.getURL?.(e)||e}function ot(){return globalThis.chrome}async function st(){if(!et){let e={workerPath:at(`tesseract/worker.min.js`),corePath:at(`tesseract-core`)};et=(0,Ue.createWorker)(`eng`,1,{...e,workerBlobURL:!0}).catch(t=>(console.warn(`OCR worker blob gagal dibuat, mencoba worker langsung:`,t),(0,Ue.createWorker)(`eng`,1,{...e,workerBlobURL:!1})))}return et}function ct(e,t,n){let r,i=new Promise((e,i)=>{r=window.setTimeout(()=>i(Error(n)),t)});return Promise.race([e,i]).finally(()=>{typeof r==`number`&&window.clearTimeout(r)})}function lt(){return $e+(H.get(`OCR`)||0)}function ut(e){let t={algorithm:e,matchCount:H.get(e)||0,executionTimeMs:V.get(e)||0},n=U.get(e);return typeof n==`number`&&(t.comparisons=n),t}function dt(e){return{totalMatches:e,keywordFrequencies:Array.from(z.entries()).map(([e,t])=>({keyword:e,count:t})).sort((e,t)=>t.count-e.count),algorithms:We.map(ut),scannedAt:new Date().toISOString(),pageUrl:window.location.href,pageTitle:document.title}}function Y(){ft(dt(lt()))}function ft(e){O(e).catch(e=>{console.error(`Gagal menyimpan statistik scan:`,e)})}function pt(){z.clear(),B.clear(),q.clear(),V.clear(),H.clear(),U.clear(),We.forEach(e=>{V.set(e,0),H.set(e,0),U.set(e,0)})}function mt(e){return e.currentSrc||e.src}function ht(e){let t=ot(),n=t?.runtime?.sendMessage;return n?new Promise(r=>{n({type:`SWEETBONANZA_FETCH_IMAGE`,url:e},e=>{let n=t?.runtime?.lastError?.message;if(n||!e?.ok){(n||e?.error)&&console.warn(`Gambar OCR tidak dapat diambil lewat background:`,n||e?.error),r(null);return}r(e.dataUrl)})}):Promise.resolve(null)}function gt(){let e=ot(),t=e?.runtime?.sendMessage;return t?new Promise(n=>{t({type:`SWEETBONANZA_CAPTURE_VISIBLE_TAB`},t=>{let r=e?.runtime?.lastError?.message;if(r||!t?.ok){(r||t?.error)&&console.warn(`Screenshot OCR tidak dapat diambil:`,r||t?.error),n(null);return}n(t.dataUrl)})}):Promise.resolve(null)}async function _t(e){let t=mt(e);return t.startsWith(`data:`)?t:(t.startsWith(`http://`)||t.startsWith(`https://`))&&await ht(t)||e}function vt(e){rt=e,document.querySelectorAll(`.sweetbonanza-highlighted-word`).forEach(t=>{e?(t.style.filter=`blur(4px)`,t.dataset.sweetbonanzaBlurred=`true`):(t.style.filter=``,delete t.dataset.sweetbonanzaBlurred)})}function yt(e,t){e.dataset.sweetbonanzaOcrDetected=`true`,e.dataset.sweetbonanzaOcrKeywords=t.join(`, `),delete e.dataset.sweetbonanzaOcrFailures,e.style.filter=`blur(8px)`,e.style.outline=`3px solid #b42318`,e.style.outlineOffset=`2px`,e.title=`Judol terdeteksi dari OCR: ${t.join(`, `)}`}function bt(e){delete e.dataset.sweetbonanzaOcrProcessed,delete e.dataset.sweetbonanzaOcrDetected,delete e.dataset.sweetbonanzaOcrKeywords,delete e.dataset.sweetbonanzaOcrFailures,e.style.filter=``,e.style.outline=``,e.style.outlineOffset=``,e.removeAttribute(`title`)}function xt(){document.querySelectorAll(`img[data-sweetbonanza-ocr-processed='true'], img[data-sweetbonanza-ocr-detected='true'], img[data-sweetbonanza-ocr-failures]`).forEach(bt)}function St(){H.set(`OCR`,0),V.set(`OCR`,0),U.set(`OCR`,0),q.clear();for(let[e,t]of B.entries()){let n=(z.get(e)||0)-t;n>0?z.set(e,n):z.delete(e)}B.clear(),Y()}function Ct(e){let t=e.getBoundingClientRect(),n=window.getComputedStyle(e);return e.complete&&e.naturalWidth>=W&&e.naturalHeight>=W&&t.width>=W&&t.height>=W&&n.display!==`none`&&n.visibility!==`hidden`&&n.opacity!==`0`}function wt(e){let t=Number(e.dataset.sweetbonanzaOcrFailures||`0`);return Number.isFinite(t)?t:0}function Tt(e,t){let n=wt(e)+1;e.dataset.sweetbonanzaOcrFailures=String(n),X(0),Y(),console.warn(`OCR gambar gagal diproses (${n}/${Je}):`,t)}function Et(e){return!e.dataset.sweetbonanzaOcrProcessed&&wt(e)<Je&&Ct(e)}function Dt(){return Array.from(document.images).filter(Et).sort((e,t)=>e.getBoundingClientRect().top-t.getBoundingClientRect().top).slice(0,Ge)}function Ot(){return Array.from(document.images).some(Et)}function kt(e){let t=e.flatMap(e=>e.matches),n=new Set,r=[];for(let e of t){let t=`${e.startIndex}:${e.endIndex}:${e.keyword.toLowerCase()}`;n.has(t)||(n.add(t),r.push(e))}return r}function At(e){return kt([d(e,R),m(e,R),_(e),E(e,R)])}function jt(e){return new Promise((t,n)=>{let r=new Image;r.onload=()=>t(r),r.onerror=()=>n(Error(`Data gambar OCR tidak dapat dimuat.`)),r.src=e})}async function Mt(e){if(!e.startsWith(`data:image/`))return e;let t=await jt(e),n=t.naturalWidth||t.width,r=t.naturalHeight||t.height,i=Math.max(n,r);if(n<=0||r<=0||i<=0)return e;let a=1;i<Ye?a=Math.min(3,Ye/i):i>Xe&&(a=Xe/i);let o=Math.max(1,Math.round(n*a)),s=Math.max(1,Math.round(r*a)),c=document.createElement(`canvas`);c.width=o,c.height=s;let l=c.getContext(`2d`);return l?(l.fillStyle=`#ffffff`,l.fillRect(0,0,o,s),l.imageSmoothingEnabled=!0,l.imageSmoothingQuality=`high`,l.filter=`grayscale(1) contrast(1.35)`,l.drawImage(t,0,0,o,s),c.toDataURL(`image/png`)):e}async function Nt(e){if(typeof e!=`string`)return e;try{return await Mt(e)}catch(t){return console.warn(`Preprocessing OCR gagal, memakai gambar asli:`,t),e}}function Pt(e,t){U.set(`OCR`,(U.get(`OCR`)||0)+1),V.set(`OCR`,(V.get(`OCR`)||0)+t),H.set(`OCR`,(H.get(`OCR`)||0)+e.length);for(let t of e){let e=t.keyword.toLowerCase();z.set(e,(z.get(e)||0)+1),B.set(e,(B.get(e)||0)+1)}}function X(e){U.set(`OCR`,(U.get(`OCR`)||0)+1),V.set(`OCR`,(V.get(`OCR`)||0)+e)}async function Ft(e,t,n){let r=performance.now(),i=await Nt(t),a=(await ct(e.recognize(i),Qe,n)).data.text||``;return{matches:At(a),executionTimeMs:performance.now()-r,text:a}}function It(){let e=Math.max(window.innerHeight,1),t=Math.round(window.scrollY/e);return`${window.location.href}:${t}:${window.innerWidth}x${window.innerHeight}`}async function Lt(e){let t=It();if(q.has(t))return!1;let n=await gt();if(!n)return!1;q.add(t);try{let t=await Ft(e,n,`OCR screenshot melewati batas waktu.`);return t.matches.length>0?Pt(t.matches,t.executionTimeMs):X(t.executionTimeMs),console.info(`OCR screenshot selesai. Teks ${t.text.length} karakter, ${t.matches.length} match.`),Y(),!0}catch(e){return q.delete(t),console.warn(`OCR screenshot gagal diproses:`,e),!1}}function Z(e=Ke){K&&(typeof G==`number`&&window.clearTimeout(G),G=window.setTimeout(()=>{G=void 0,Rt()},e))}async function Rt(){if(!K)return;if(tt){nt=!0;return}let e=!1;tt=!0;try{let t=performance.now(),n;try{n=await ct(st(),Ze,`OCR worker melewati batas waktu inisialisasi.`)}catch(e){X(performance.now()-t),Y(),console.warn(`OCR worker gagal disiapkan:`,e);return}let r=await Lt(n),i=Dt();if(i.length===0){r||console.info(`OCR aktif, tetapi belum ada gambar visible yang memenuhi ukuran minimum.`);return}for(let e of i)try{let t=await _t(e),r=await Ft(n,t,`OCR gambar melewati batas waktu.`);e.dataset.sweetbonanzaOcrProcessed=`true`,r.matches.length>0?(Pt(r.matches,r.executionTimeMs),yt(e,Array.from(new Set(r.matches.map(e=>e.keyword))))):X(r.executionTimeMs),console.info(`OCR gambar selesai. Teks ${r.text.length} karakter, ${r.matches.length} match.`),Y()}catch(t){Tt(e,t)}e=Ot()}finally{tt=!1,(nt||e)&&(nt=!1,Z(e?qe:Ke))}}function zt(){let e=()=>Z(),t=e=>{e.target instanceof HTMLImageElement&&Z()},n=new MutationObserver(e=>{e.some(e=>e.type===`attributes`&&e.target instanceof HTMLImageElement?(bt(e.target),!0):Array.from(e.addedNodes).some(e=>e instanceof HTMLImageElement?!0:e instanceof HTMLElement&&!!e.querySelector(`img`)))&&Z()});return window.addEventListener(`load`,e),window.addEventListener(`scroll`,e,{passive:!0}),window.addEventListener(`resize`,e),document.addEventListener(`load`,t,!0),n.observe(document.body,{attributeFilter:[`src`,`srcset`],attributes:!0,childList:!0,subtree:!0}),()=>{window.removeEventListener(`load`,e),window.removeEventListener(`scroll`,e),window.removeEventListener(`resize`,e),document.removeEventListener(`load`,t,!0),n.disconnect(),typeof G==`number`&&window.clearTimeout(G)}}async function Bt(){let[e,t]=await Promise.all([ae(),re()]);vt(e),K=t;let n=M(e=>{vt(e)}),r=ie(e=>{if(K=e,e){Z(0);return}xt(),St()}),i=zt();window.addEventListener(`unload`,()=>{n(),r(),i()},{once:!0}),t&&Z(0)}function Vt(){let e=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,{acceptNode:e=>{if(!e.nodeValue?.trim())return NodeFilter.FILTER_REJECT;let t=e.parentElement;return!t||t.closest(`script, style, noscript, mark, input, textarea, code, pre`)||t.isContentEditable?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),t=[],n=e.nextNode();for(;n;)t.push(n),n=e.nextNode();let r=0;for(let e of t){let t=e.nodeValue||``,n=[d(t,R),m(t,R),_(t),E(t,R)];r+=it(t,n,e)}document.querySelectorAll(`.sweetbonanza-highlighted-word`).forEach(e=>{let t=e;t.addEventListener(`mouseenter`,e=>{let n=e,r=t.dataset.keyword||``,i=r.toLowerCase(),a=z.get(i)||0,o=t.dataset.algorithms||``,s=``;o.split(`, `).forEach(e=>{if(!e)return;let t=V.get(e)||0;s+=`- ${e}: ${t.toFixed(3)} ms<br>`}),J.innerHTML=`
            ...
            ${s}
          `,J.style.display=`block`,J.style.left=`${n.pageX+15}px`,J.style.top=`${n.pageY+15}px`}),t.addEventListener(`mousemove`,e=>{let t=e;J.style.left=`${t.pageX+15}px`,J.style.top=`${t.pageY+15}px`}),t.addEventListener(`mouseleave`,()=>{J.style.display=`none`})}),console.log(`Pencarian selesai. Ditemukan ${r} kata unik.`),console.log(`Statistik Waktu per algoritma:`,Object.fromEntries(V)),$e=r,Y()}function Ht(){let e=Array.from(document.querySelectorAll(`.sweetbonanza-highlighted-word`));if(e.length==0)return;let t=new Set;for(let n of e){let e=n.parentElement;if(e){t.add(e);let r=document.createTextNode(n.textContent||``);e.replaceChild(r,n)}}for(let e of t)e.normalize();J.style.display=`none`}var Q=null,$=null;function Ut(){Q||(Q=new MutationObserver(e=>{let t=!1;for(let n of e){let e=!1;if(n.type===`childList`&&n.addedNodes.forEach(t=>{t instanceof HTMLElement&&(t.classList.contains(`sweetbonanza-highlighted-word`)||t.querySelector(`.sweetbonanza-highlighted-word`))&&(e=!0)}),!e){t=!0;break}}t&&($!==null&&clearTimeout($),$=window.setTimeout(()=>{Kt()},500))}),Q.observe(document.body,{childList:!0,subtree:!0,characterData:!0}))}function Wt(){Q&&=(Q.disconnect(),null),$!==null&&(clearTimeout($),$=null)}var Gt=!1;function Kt(){if(!Gt){Gt=!0,Wt();try{Ht(),xt(),pt(),Vt(),K&&Z(0)}catch(e){console.error(`Gagal melakukan scan halaman: `,e)}finally{Gt=!1,Ut()}}}chrome.runtime.onMessage.addListener((e,t,n)=>(e.type===`SWEETBONANZA_RESCAN`&&(Kt(),n({status:`success`})),!0)),Kt(),Bt()})();